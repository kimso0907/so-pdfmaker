...
<body>
   ...
   <div align="center">
	  ...
	  <div align="right" onclick="download()" style="margin:10px;"><button id="btn_download" class="btn-add-disable" disabled="disabled">다운로드</button></div>
      <div>
   ...
   <form id="downloadSubmit" action="/downloadFromMaker.do" method="post">
   		<input id="downloadParam" type="hidden" name="pdfBody">
   </form>
</body>
</html>